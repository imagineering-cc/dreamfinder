...
void main() {
  ...
  // Self-echo detection moved to ParticipantClassifier — coverage now lives in
  // test/matrix/participant_test.dart. selfPuppetIds/bridgeBotIds remain on Env
  // as the config that seeds that classifier.
}
